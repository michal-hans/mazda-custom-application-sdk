...
CustomApplicationsHandler.register("app.aso", new CustomApplication({
	...
	require: {
		...
		images: {
			image1: 'images/aso-1.jpg',
			image2: 'images/aso-2.jpg'
		}
	},
	...
	created: function() {
		...
		this.image1 = this.element("div", false, "bg", {
			position: 'absolute',
			top: 0,
			left: 0,
			bottom: 0,
		...
		this.image2 = this.element("div", false, "bg", {
			position: 'absolute',
			top: 0,
			left: 0,
			bottom: 0,
